...
| `references/shared/artifacts/skill-files.md` | `SKILL.md`, `AGENTS.md`, prompt templates, tool wrappers, and instruction-precedence review |
...
- Load `skill-files.md` when the repo itself is a skill, agent, prompt, or LLM-integration target, or when prompt templates and instruction files are first-class assets.
